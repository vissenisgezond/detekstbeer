...
// Get the position of the "Recent Werk" button
var rect = btn.getBoundingClientRect();
var topPos = rect.bottom + window.scrollY; // Gebruik rect.bottom om de onderkant van de knop te krijgen
var leftPos = rect.left + window.scrollX + rect.width / 2; // rect.width / 2 om het midden van de knop te krijgen

// Set the position of the modal
modal.style.top = topPos + "px";
modal.style.left = leftPos + "px";
modal.style.transform = "translateX(-50%)"; // Center the modal relative to its own width

// When the user clicks the button, open the modal 
btn.onclick = function(event) {
  event.preventDefault(); // Voorkomt dat de pagina scrollt naar de ankerlink
